...
1. 前往 [**Releases**](../../releases/latest) 下载最新的 [`Y-Clip-v1.0.17.dmg`](https://github.com/Rainchen537/Y-Clip/releases/download/v1.0.17/Y-Clip-v1.0.17.dmg)
...
历史面板右上角有图钉和齿轮按钮：图钉用于切换固定状态，齿轮可直接打开设置，适合菜单栏图标被系统隐藏时使用。
